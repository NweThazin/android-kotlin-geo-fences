...
class HuntMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Geofencing client is the main entry point for interacting with the geofencing APIs
 ...
 */
    ...
    private fun foregroundAndBackgroundLocationPermissionApproved(): Boolean {
        //  Step 3 replace this with code to check that the foreground and background permissions were approved
